  ...
  tabItems(
    tabItem(tabName = "data",
            ...
            fluidRow(box(plotOutput("plot1", height = 250)),
                     box(h5("We examined reviews from March 2019 through the beginning of 2021. Since shutdowns associated with Covid-19 began in the United States around mid-march, we split our dataset into two around that time. We also removed a one month window of data (3/1/20-4/1/20). ")))
